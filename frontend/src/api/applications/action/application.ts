...
export const applicationActions = {
  getApplications: async (vacancyId: string, body: ApplicationsParamsDto): Promise<ApplicationsResponse> => {
    const response = await api.post(`/api/Vacancies/${vacancyId}/applications/search`, body);
    console.log('response', response.data, 'body', body)
